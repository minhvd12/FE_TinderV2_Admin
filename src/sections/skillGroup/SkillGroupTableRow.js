...
export default function SkillGroupTableRow({ row, selected, onEditRow,  onDeleteRow, onEditRowError }) {
  // const { id, name } = row;
  ...
  return (
    <TableRow hover selected={selected}>
      ...
      <Dialog
        ...
        maxWidth="xs"
      >
        <DialogTitle id="alert-dialog-title">Sửa nhóm kỹ năng</DialogTitle>
        <DialogContent>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={handleCloseDialogDelete} color="inherit" variant="outlined">
            Huỷ
          </Button>
          <Button
            onClick={() => {
